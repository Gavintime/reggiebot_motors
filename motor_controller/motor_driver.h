...
namespace MotorDriver
{
    ...
    int8_t setMotorSpeed(MotorSelection motor, int16_t motor_speed);
    int8_t setMotorSpeeds(int16_t left_motor_speed, int16_t right_motor_speed);
    int16_t getMotorSpeed(MotorSelection motor);
    void stopMotors();
